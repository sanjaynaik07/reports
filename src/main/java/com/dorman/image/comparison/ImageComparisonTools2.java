 ...
 */
public class ImageComparisonTools2 {
	 ...
	 * 
	 * @param image1
	 *            {@code BufferedImage} object of the first image.
	 * @param image2
	 *            {@code BufferedImage} object of the second image.
	 */
	...
	/**
	 * Says if the two pixels equal or not. The rule is the difference between two
	 * pixels need to be more then 10%.
	 * 
	 * @param rgb1
	...
	/**
	 * Populate binary matrix by "0" and "1". If the pixels are difference set it as
	 * "1", otherwise "0".
	 * 
	 * @param image1
	 *            {@code BufferedImage} object of the first image.
	 ...
	 */
	public static BufferedImage readImageFromResources2(String path) throws IOException, URISyntaxException {
	 ...
	 * @param image
	 *            the {@code BufferedImage} object of this specific image.
	 * @throws IOException
	 */
